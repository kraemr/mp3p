...
namespace Mp3Gui {
    ...
    extern Mp3PlayerImage::stb_IMAGE playButton_img;
    extern Mp3PlayerImage::stb_IMAGE pauseButton_img;
    extern Mp3PlayerImage::stb_IMAGE prevButton_img;
    extern Mp3PlayerImage::stb_IMAGE exitButton_img;
    extern Mp3PlayerImage::stb_IMAGE skipButton_img;
    extern Mp3PlayerImage::stb_IMAGE settingsButton_img;
    extern Mp3PlayerImage::stb_IMAGE cutomizeButton_img;
    extern Mp3PlayerImage::stb_IMAGE currentPlaylist_image;
